export const GEO_DATASETS = {
  all: {
    ...
    label: 'Toda España',
    municipiosPaths: [
      '/data/galicia_municipios.geojson',
      '/data/asturias_municipios.geojson',
      '/data/cantabria_municipios.geojson',
      '/data/castilla_leon_municipios.geojson',
      '/data/aragon_municipios.geojson',
      '/data/madrid_municipios.geojson',
      '/data/navarra_municipios.geojson',
      '/data/la_rioja_municipios.geojson',
      '/data/murcia_municipios.geojson',
      '/data/ceuta_municipios.geojson',
      '/data/melilla_municipios.geojson',
      '/data/comunitat_valenciana_municipios.geojson',
      '/data/illes_balears_municipios.geojson',
      '/data/euskadi_municipios.geojson',
      '/data/extremadura_municipios.geojson',
      '/data/castilla_la_mancha_municipios.geojson',
      '/data/canarias_municipios.geojson',
      '/data/andalucia_municipios.geojson',
      '/data/catalunya_municipios.geojson',
    ],
  ...
  catalunya: {
    id: 'catalunya',
    name: 'Catalunya',
    municipiosPath: '/data/catalunya_municipios.geojson',
  },
}
